...
$(".link-color").click(function(){
  ...
  var folder = "https://tonalmasher.github.io/violetfivel/lib/images/color/";
//  var folder = "lib/images/color/";
  $.ajax({
      url : folder,
...
$(".link-black").click(function(){
  ...
  var folder = "https://tonalmasher.github.io/violetfivel/lib/images/blackwork/";
//  var folder = "lib/images/blackwork/";
  $.ajax({
      url : folder,
      success: function (data) {
          $(data).find("a").attr("href", function (i, val) {
...
$(".link-paintings").click(function(){
  ...
  var folder = "https://tonalmasher.github.io/violetfivel/lib/images/paintings/";
//  var folder = "lib/images/paintings/";
  $.ajax({
      url : folder,
      success: function (data) {
          $(data).find("a").attr("href", function (i, val) {
